...
class WebQueryClient(object):
    def __init__(self, base_url, detail_url, query_params, decode_key):
        self.url = base_url
    ...
    def get_ETA(self, df, start="강남역"):
        if start == "강남역":
            ...
            raise NotImplementedError("Starting points other than Gangnam Station are not implemented or provided.")
